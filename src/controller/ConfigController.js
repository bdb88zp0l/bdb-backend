...
/**
 * Require the Workspace model from the '../model/Workspace' module.
 * This model is used to interact with the database for workspace configuration data.
 */
...
exports.getConfig = catchAsync(async (req, res) => {
  ...
  let workspaces = await Workspace.find({ status: "active" }).lean();
